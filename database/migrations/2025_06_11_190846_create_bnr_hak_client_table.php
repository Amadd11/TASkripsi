...
return new class extends Migration
{
    ...
    {
        Schema::create('bnr_hak_client', function (Blueprint $table) {
            $table->increments('id_bnr_hak_client');
            $table->boolean('is_ic')->default(0); // Diubah dari int ke boolean (informed consent)
    ...
    {
        Schema::dropIfExists('bnr_hak_client');
    }
};
