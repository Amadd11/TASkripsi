...
return new class extends Migration
{
    ...
    {
        Schema::create('bnr_reaksi_makanan', function (Blueprint $table) {
            $table->increments('id_bnr_reaksi_makanan');
            $table->boolean('is_efek_makanan')->default(0); // Diubah dari int ke boolean
    ...
    {
        Schema::dropIfExists('bnr_reaksi_makanan');
    }
};
