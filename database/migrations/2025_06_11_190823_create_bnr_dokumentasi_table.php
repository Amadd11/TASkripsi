...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bnr_dokumentasi', function (Blueprint $table) {
            ...
            $table->boolean('is_obat')->default(0); // Diubah dari int ke boolean
            $table->boolean('is_waktu')->default(0); // Diubah dari int ke boolean
            $table->boolean('is_rute')->default(0); // Diubah dari int ke boolean
            $table->timestamps();
            // Foreign Keys
    ...
    {
        Schema::dropIfExists('bnr_dokumentasi');
    }
};
