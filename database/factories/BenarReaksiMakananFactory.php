...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\BenarReaksiMakanan>
 */
class BenarReaksiMakananFactory extends Factory
{
    protected $model = BenarReaksiMakanan::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'is_efek_makanan' => $this->faker->boolean(80),
