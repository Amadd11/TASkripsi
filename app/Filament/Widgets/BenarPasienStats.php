...
class BenarPasienStats extends Widget
{
    protected static ?string $heading = 'Benar Pasien Pada Bulan ini';

    protected static string $view = 'filament.widgets.benar-pasien-stats';
    ...
    protected function updateStats(): void
    {
        ...
        if ($this->total === 0) {
            ...
            $this->allTrue = BenarPasien::query()
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->where('is_nama', true)
                ->where('is_tgl_lahir', true)
                ->count();
