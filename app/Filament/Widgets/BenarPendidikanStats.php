...
class BenarPendidikanStats extends Widget
{
    protected static ?string $heading = 'Benar Pendidikan Pada Bulan ini';

    protected static string $view = 'filament.widgets.benar-pendidikan-stats';
    ...
    protected function updateStats(): void
    {
        ...
        if ($this->total === 0) {
            ...
            $this->allTrue = BenarPendidikan::query()
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->where('is_edukasi', true)
                ->count();
