...
class BenarReaksiMakananStats extends Widget
{
    protected static ?string $heading = 'Benar Reaksi Makanan Pada Bulan ini';

    protected static string $view = 'filament.widgets.benar-reaksi-makanan-stats';
    ...
    protected function updateStats(): void
    {
        ...
        if ($this->total === 0) {
            ...
            $this->allTrue = BenarReaksiMakanan::query()
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->where('is_efek_makanan', true)
                ->count();
